...
void StageSelect::Initialize() {
	...
	moon_.reset(new Model{});
	player_.reset(new Model{});

	backGroundBlur_.reset(new PeraRender{});

	bubble_.reset(new Texture2D{});
	stageNumberTex_.reset(new Texture2D{});
	stageTenNumberTex_.reset(new Texture2D{});
	stageTex_.reset(new Texture2D{});
	arrowRight_.reset(new Texture2D{});
	arrowLeft_.reset(new Texture2D{});
	isClearTex_.reset(new Texture2D{});
	...
	rotateEase_.reset(new Easing{});
	bubbleEase_.reset(new Easing{});
